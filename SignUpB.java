...
public class SignUpB extends JFrame implements ActionListener{
	...
	public SignUpB(){
		...
		l10 = new JLabel("Existing Acoount");
		...
		String income [] = {"Null", "Upto 30,000", "upto 50,000", "Between 50,000 & 1,00,000"};
		c3 = new JComboBox<String>(income);
		c3.setBackground(Color.WHITE);
		c3.setFont(new Font("Raleway", Font.BOLD, 14));
		
		String education [] = {"Null","upto 8","upto 10","Upto 12", "UG", "PG", "PhD", "Other"};
		c4 = new JComboBox<String>(education);
		c4.setBackground(Color.WHITE);
		c4.setFont(new Font("Raleway", Font.BOLD, 14));
		
		String occupation [] = {"Salaried", "Self-Employed", "Business", "Studentt", "Retired", "Other"};
		...
		l12.setBounds(300,10,90,30);
		add(l12);
		
		t3.setBounds(400,10,60,30);
		add(t3);
