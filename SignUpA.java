...
public class SignUpA extends JFrame implements ActionListener{
    ...
    SignUpA(){
        ...
        l13.setBounds(300, 240, 200, 30);
        add(l13);
        
        c1.setBounds(340, 240, 60, 30);
        add(c1);
        
        l14.setBounds(410, 240, 80, 30);
        add(l14);
        
        c2.setBounds(465, 240, 60, 30);
        add(c2);
        
        l15.setBounds(540, 240, 60, 30);
        add(l15);
        
        c3.setBounds(590,240,90,30);
        add(c3); 
        
        l6.setBounds(100,290,90,30);
        add(l6);
